...
# OS-IMAGE #
$(BUILDDIR)/os-image.bin: $(BOOTDIR)/linker.ld $(BUILDDIR)/boot_sect.o $(BUILDDIR)/read_vesa.o
	ld -melf_i386 --build-id=none -o $(BUILDDIR)/os-image.elf -T $^
	objcopy -O binary $(BUILDDIR)/os-image.elf $@
